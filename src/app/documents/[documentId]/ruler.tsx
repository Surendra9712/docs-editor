...
const Marker = ({position, isLeft, isDragging, onMouseDown, onDoubleClick}: MarkerProps) => {
    return (<div className="absolute top-0 w-4 h-full cursor-ew-resize z-[5] group -ml-2"
        ...
        >
           <span className="absolute left-1/2 top-0 h-full text-blue-500 transform -translate-x-1/2">
            ...
            <div className={cn("absolute left-1/2 top-4 transform -translate-x-1/2 w-[1px] bg-blue-500 h-screen scale-x-50", isDragging?"block":"hidden")}
            />
        </div>
    )
}
